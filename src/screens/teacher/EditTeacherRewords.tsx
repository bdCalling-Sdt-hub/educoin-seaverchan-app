...
import { categories } from './TeacherAddCategory';

const TeacherEditRewords = ({navigation}: NavigProps<null>) => {
  ...
  const [customPoints, setCustomPoints] = React.useState<number>(5);
